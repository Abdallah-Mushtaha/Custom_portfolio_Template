...
const skillsData = [
  ...
  },
  {
    ...
    skills: ["Redux", "Zustand", "React Query", "Jotai"],
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillsData.map((skill, index) => (
            <div
              key={index}
              data-aos="zoom-in"
              className="bg-[#0d1117] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-border border-gray-700/50"
            >
